...
//            sign.getSide(Side.BACK).setLine(3, ChatColor.BLACK.toString() + ChatColor.ITALIC + "Click For Info");
//            sign.getSide(Side.FRONT).setLine(3, ChatColor.BLACK.toString() + ChatColor.ITALIC + "Click For Info");
//            sign.setWaxed(true);
